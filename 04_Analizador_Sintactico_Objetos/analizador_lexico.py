...
class AnalizadorLexico:
    ...
    def obtener_categoria_token(self, tipo_token):
        descripciones = {
            ...
            CategoriaToken.OPERADOR_MULTIPLICATIVO: "Operador Multiplicación / División",
            ...
            CategoriaToken.OPERADOR_IGUALDAD: "Operador de Igualdad",
            ...
            CategoriaToken.OPERADOR_ASIGNACION: "Operador de Asignación",
            CategoriaToken.PALABRA_CLAVE_IF: "Palabra Reservada",
            CategoriaToken.PALABRA_CLAVE_WHILE: "Palabra Reservada",
            CategoriaToken.PALABRA_CLAVE_RETURN: "Palabra Reservada",
            CategoriaToken.PALABRA_CLAVE_ELSE: "Palabra Reservada",
        ...
        while self.continuar_escaneo:
            ...
            if self.estado_actual == 0:
                ...
                if self.es_letra(self.caracter_actual) or self.es_digito(self.caracter_actual):
                    ...
                    if self.token_actual in ["int", "float", "void"]:
    ...
    def obtener_siguiente_caracter(self):
        while not self.entrada_consumida():
            caracter = self.fuente_entrada[self.posicion]
            self.posicion += 1
            if not self.es_espacio_blanco(caracter):
                return caracter
        return '$'
